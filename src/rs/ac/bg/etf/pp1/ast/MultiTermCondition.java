...
public class MultiTermCondition extends Condition {

    private Condition Condition;
    private ConditionTerm ConditionTerm;

    public MultiTermCondition (Condition Condition, ConditionTerm ConditionTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultiTermCondition(\n");
