...
public class BaseClassWithMethodsDecl extends ClassDecl {
    ...
    public BaseClassWithMethodsDecl (String className, VarDeclList VarDeclList, ConstructorDecl ConstructorDecl, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("BaseClassWithMethodsDecl(\n");
