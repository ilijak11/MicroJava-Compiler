...
public class UnmatchedIfElseStmt extends UnmatchedStatement {

    private Condition Condition;
    private MatchedStatement MatchedStatement;
    private UnmatchedStatement UnmatchedStatement;

    public UnmatchedIfElseStmt (Condition Condition, MatchedStatement MatchedStatement, UnmatchedStatement UnmatchedStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("UnmatchedIfElseStmt(\n");
