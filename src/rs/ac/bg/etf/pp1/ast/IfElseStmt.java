...
public class IfElseStmt extends MatchedStatement {

    private Condition Condition;
    private MatchedStatement MatchedStatement;
    private MatchedStatement MatchedStatement1;

    public IfElseStmt (Condition Condition, MatchedStatement MatchedStatement, MatchedStatement MatchedStatement1) {
